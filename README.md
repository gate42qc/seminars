...
| :----            			|	:----: 	 	         			|     :----:      						    			 |          ----:     |
|					|				 			|											 |		      |
| 32. Combining dynamical decoupling and other Error mitigation techniques to improve reliability of  quantum computers |[arXiv:0911.3202](https://arxiv.org/pdf/0911.3202.pdf)|DD pulse sequences can improve the reliability of quantum computers. DD-protected quantum gates outperform unprotected gates. Under suitable conditions, fault-tolerant quantum circuits constructed from DD-protected gates can tolerate stronger noise, and have a lower overhead cost, than fault-tolerant circuits constructed from unprotected gates. Another Error Mitigation technique uses Richardson expansion to extrapolate to the zero noise limit of the expectation value of some quantum observable with respect to an evolved quantum state. Combination of both techniques is considered.| Arshak Hovhannisyan |
